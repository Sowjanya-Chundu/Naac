...
<head>
    ...
    <style>
        ...
        .menu-open .menu-line1 {
            transform: rotate(-45deg) translate(-5px, 5px);
        }
        .menu-open .menu-line2 {
            opacity: 0;
        }
        .menu-open .menu-line3 {
            transform: rotate(45deg) translate(-5px, -5px);
        }
        .menu-options {
            position: absolute;
...
<table>
    ...
    <% 
        ...
        try {
            ...
            // Initialize counters for total students appeared and passed
            int totalStudentsAppeared = 0;
            int totalStudentsPassed = 0;
            
            // Process each row of ResultSet
            while (rs.next()) {
                String academicYear = rs.getString("Academic");
                String programCode = rs.getString("Programme Code");
                String programName = rs.getString("Programme Name");
                int studentsAppeared = rs.getInt("Number of students who appeared in the final year examinations");
                int studentsPassed = rs.getInt("Number of students who passed in the final year examinations");
                
                // Increment counters
                totalStudentsAppeared += studentsAppeared;
                totalStudentsPassed += studentsPassed;
                ...
                out.println("<td>"+ studentsPassed + "</td>");
                out.println("</tr>");
            }
            
            // Display total counts below the main table with clickable links
            out.println("<tr>");
            out.println("<td colspan='3'><b>Total Students Appeared:</b></td>");
            out.println("<td><a href='TotalAppeared.jsp?count=" + totalStudentsAppeared + "'>" + totalStudentsAppeared + "</a></td>");
            out.println("<td><b>Total Students Passed:</b></td>");
            out.println("<td><a href='PassedStudents.jsp'>" + totalStudentsPassed + "</a></td>");
            out.println("</tr>");
