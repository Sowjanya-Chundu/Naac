...
<%
    ...
    try {
        ...
        String insertSql = "INSERT INTO project.`2020-21faculty` (`S.No`, `Name`, `Designation`, `Qualification`, `Area of Specialization`, `EXP`) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        // SQL select query
        String selectSql = "SELECT * FROM project.`2020-21faculty`";
