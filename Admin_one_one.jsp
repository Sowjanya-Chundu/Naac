...
<body>
    <table>
        ...
        <%
            ...
            try {
                ...
                String query = "SELECT programmename, programmecode, `Semester/Year`, lastsemesterendyear, resultsofthesemester FROM semesteryear WHERE programmename='Information Technology' AND `Semester/Year` ='I-I'";
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <form id="addForm" method="post" action="AdminsemAddI-I.jsp">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <h2>Edit Record</h2>
            <form id="editForm" method="post" action="AdminsemEditI-I.jsp">
    ...
    function deleteRow(code) {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            xhr.open("GET", "AdminsemDeleteI-I.jsp?code=" + code, true);
