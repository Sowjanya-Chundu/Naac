...
try {
    ...
    String sql = "SELECT * FROM project.`2022-23faculty`";
...
<div id="addModal" class="modal">
    <div class="modal-content">
        ...
        <form id="addForm" method="post" action="AdminfacultyAddRecord2022-23.jsp">
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Record</h2>
        <form id="editForm" method="post" action="AdminfacultyEditRecord2022-23.jsp">
...
<script>
    ...
    function deleteRow(sno) {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            xhr.open("GET", "AdminfacultyDeleteRecord2022-23.jsp?sno=" + sno, true);
