...
try {
    ...
    while (result.next()) {
        ...
        // Create a link for each faculty name
        out.println("<tr>");
        out.println("<td>" + sno + "</td>");
        out.println("<td><a href='facultyDetails.jsp?name=" + URLEncoder.encode(Name, "UTF-8") + "'>" + Name + "</a></td>");
        out.println("<td>" + Qualification + "</td>");
        out.println("<td>" + AreaofSpecialization + "</td>");k
