...
<%
    ...
    try {
        ...
        String insertSql = "INSERT INTO project.councel2ndbtech (`S.No`, `II  B.TECH`, `Name of the Counselor`, `Counselor Mobile Number`) VALUES (?, ?, ?, ?)";
        ...
        // SQL select query
        String selectSql = "SELECT * FROM project.councel2ndbtech";
