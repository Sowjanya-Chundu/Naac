...
<%
    ...
    try {
        ...
        String insertSql = "INSERT INTO project.`2021-22faculty` (`S.No`, `Name`, `Designation`, `Qualification`, `Area of Specialization`, `EXP`) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        // SQL select query
        String selectSql = "SELECT * FROM project.`2021-22faculty`";
