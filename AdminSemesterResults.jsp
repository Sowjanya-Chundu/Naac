  ...
  <script>
    ...
    function fetchAndDisplayData() {
        ...
        if (semesteryear === "ALL" && department === "ALL") {
            url = "AdminAllsemesters.jsp"; // Adjust this URL to your all details page
        } else {
            switch (semesteryear) {
                case "I-I":
                    url = department === "IT" ? "Admin_one_one.jsp" : "default.html";
                    break;
                case "I-II":
                    url = department === "IT" ? "Admin_one_two.jsp" : "default.html";
                    break;
                case "II-I":
                    url = department === "IT" ? "Admin_two_one.jsp" : "default.html";
                    break;
                case "II-II":
                    url = department === "IT" ? "Admin_two_two.jsp" : "default.html";
                    break;
                case "III-I":
                    url = department === "IT" ? "Admin_three_one.jsp" : "default.html";
                    break;
                case "III-II":
                    url = department === "IT" ? "Admin_three_two.jsp" : "default.html";
                    break;
                case "IV-I":
                    url = department === "IT" ? "Admin_four_one.jsp" : "default.html";
                    break;
                case "IV-II":
                    url = department === "IT" ? "Admin_four_two.jsp" : "default.html";
                    break;
                default:
