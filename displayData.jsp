    ...
    <div id="dashboard-container">
        ...
        <div id="dashboard">
            <div id="menu">
                ...
                <a href="displayStudent.html">Retrive</a>
    ...
    <table>
        ...
        <%
            ...
            try {
                ...
                String sqlQuery = "SELECT `Name`, `RollNo`, `Gender`, `AdmissionType`, `CATEGORYOFADMISSION` FROM project.`2021-22student`";
                ...
                while (result.next()) {
                    ...
                    String setAdmissionType = result.getString("AdmissionType");
                    String CategoryOfAdmission = result.getString("CATEGORYOFADMISSION");
