...
try {
    ...
    String sql = "SELECT * FROM project.`2019-20faculty`";
...
<div id="addModal" class="modal">
    <div class="modal-content">
        ...
        <form id="addForm" method="post" action="AdminfacultyAddRecord2019-20.jsp">
            <label for="addSno">S.No:</label>
            <input type="text" id="addSno" name="sno" required><br>
            <label for="addRegdno">Name:</label>
            <input type="text" id="addRegdno" name="name" required><br>
            <label for="addName">Designation:</label>
            <input type="text" id="addName" name="designation" required><br>
            <label for="addMobile">Qualification:</label>
            <input type="text" id="addMobile" name="qualification" required><br>
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Record</h2>
        <form id="editForm" method="post" action="AdminfacultyEditRecord2019-20.jsp">
            <input type="hidden" id="editId" name="sno"> <!-- Hidden field for S.No -->
            <label for="editSno">S.No:</label>
            <input type="text" id="editSno" name="sno" readonly><br>
            <label for="editRegdno">Name:</label>
            <input type="text" id="editRegdno" name="name" required><br>
            <label for="editName">Designation:</label>
            <input type="text" id="editName" name="designation" required><br>
            <label for="editMobile">Qualification:</label>
            <input type="text" id="editMobile" name="qualification" required><br>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.edit-btn').forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                document.getElementById('editRegdno').value = name;
                document.getElementById('editName').value = designation;
                document.getElementById('editMobile').value = qualification;
    ...
    function deleteRow(sno) {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            xhr.open("GET", "AdminfacultyDeleteRecord2019-20.jsp?sno=" + sno, true);
