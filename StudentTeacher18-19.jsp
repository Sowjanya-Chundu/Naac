...
<body>
    ...
    <%
        ...
        try {
            ...
            String studentSql = "SELECT COUNT(*) AS totalStudents FROM project.studentinfbatch18";
            ...
            String teacherSql = "SELECT COUNT(*) AS totalTeachers FROM project.facultybatch18";
