...
<body>
        ...
        <table id="dataTable" border="1">
            ...
            <% 
                ...
                try {
                    ...
                    String sql = "SELECT * FROM project.projectbatcha";
                    ...
                    while (result.next()) {
                        String branch = result.getString("Batch No");
                        String specialPrograms = result.getString("Roll No.");
                        String slowAndAdvance = result.getString("Student Name");
                        String dateAndTime = result.getString("Supervisor Name");
                        ...
                        out.println("<td>"+ specialPrograms + "</td>");
                        out.println("<td>" + slowAndAdvance + "</td>");
    ...
    <a href="<%=request.getContextPath()%>/AdminLearners.jsp">Back</a> ||
