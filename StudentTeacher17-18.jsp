...
<body>
    ...
    <%
        ...
        try {
            ...
            String studentSql = "SELECT COUNT(*) AS totalStudents FROM project.studentinfbatch10";
            ...
            String teacherSql = "SELECT COUNT(*) AS totalTeachers FROM project.facultyinfbatch17";
