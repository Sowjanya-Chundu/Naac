...
<%
    ...
    try {
        ...
        String insertSql = "INSERT INTO project.`2019-20faculty` (`S.No`, `Name`, `Designation`, `Qualification`, `Area of Specialization`, `EXP`) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        // SQL select query
        String selectSql = "SELECT * FROM project.`2019-20faculty`";
