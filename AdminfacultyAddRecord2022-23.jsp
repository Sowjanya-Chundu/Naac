...
<%
    ...
    try {
        ...
        String insertSql = "INSERT INTO project.`2022-23faculty` (`S.No`, `Name`, `Designation`, `Qualification`, `Area of Specialization`, `EXP`) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        // SQL select query
        String selectSql = "SELECT * FROM project.`2022-23faculty`";
