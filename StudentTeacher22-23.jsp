...
<body>
    ...
    <%
        ...
        try {
            ...
            String studentSql = "SELECT COUNT(*) AS totalStudents FROM project.studentinfbatch21";
            ...
            String teacherSql = "SELECT COUNT(*) AS totalTeachers FROM project.`2022-23faculty`";
