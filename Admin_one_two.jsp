...
<body>
    <table>
        ...
        <%
            ...
            try {
                ...
                // Check if the form was submitted and add the new record
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <form id="addForm" method="post" action="AdminsemAddI-II.jsp">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <h2>Edit Record</h2>
            <form id="editForm" method="post" action="AdminsemEditI-II.jsp">
    ...
    function deleteRow(code) {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            xhr.open("GET", "AdminsemDeleteI-II.jsp?code=" + code, true);
