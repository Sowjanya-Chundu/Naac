...
try {
    ...
    String sql = "SELECT * FROM project.`2021-22faculty`";
...
<div id="addModal" class="modal">
    <div class="modal-content">
        ...
        <form id="addForm" method="post" action="AdminfacultyAddRecord2021-22.jsp">
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Record</h2>
        <form id="editForm" method="post" action="AdminfacultyEditRecord2021-22.jsp">
...
<script>
    ...
    function deleteRow(sno) {
        if (confirm("Are you sure you want to delete this record?")) {
            ...
            xhr.open("GET", "AdminfacultyDeleteRecord2021-22.jsp?sno=" + sno, true);
