...
<div class="menu-options" id="menuOptions">
    <a href="AdminTeacherInsert.jsp">Insert</a>
    <a href="AdminTeacherDelete.jsp">Delete</a>
    <a href="AdminTeacherRetrive.jsp">Retrieve</a>
</div> 
...
<div class="content">
    ...
    <%
        ...
        try {
            ...
            String query = "SELECT * FROM project.fulltimeteachers;";
    ...
    %>
            ...
            <table>
                ...
                %>
                        <tr>
                            <td><%= resultSet.getString("fulltimeteachers") %></td>
