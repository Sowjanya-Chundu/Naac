...
<%
    ...
    try {
        ...
        String insertSql = "INSERT INTO project.councelling4thbtech (`S.No`, `IV B.TECH`, `Name of the Counselor`, `CounselorMobileNumber`) VALUES (?, ?, ?, ?)";
        ...
        // SQL select query
        String selectSql = "SELECT * FROM project.councelling4thbtech";
...
%>
            <tr>
                ...
                <td><%= rs.getString("IV B.TECH") %></td>
                <td><%= rs.getString("Name of the Counselor") %></td>
                <td><%= rs.getString("CounselorMobileNumber") %></td>
            </tr>
<%
        }
%>
