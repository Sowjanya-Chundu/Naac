...
<body>
    ...
    <%
        ...
        try {
            ...
            String studentSql = "SELECT COUNT(*) AS totalStudents FROM studentsdata";
            ...
            if (totalTeachers > 0) {
                ...
                out.println("<div class='icon-item'><a href='studentsList.jsp?totalStudents=" + totalStudents + "'><img src='images/student.jpg' alt='Students Icon'><p>Total Students: " + totalStudents + "</p></a></div>");
                out.println("<div class='icon-item'><a href='TeacherList.jsp?totalTeachers=" + totalTeachers + "'><img src='images/teacher.jpeg' alt='Teachers Icon'><p>Total Full-Time Teachers: " + totalTeachers + "</p></a></div>");
                out.println("</div>");
