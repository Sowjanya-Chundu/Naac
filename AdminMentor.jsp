...
try {
    ...
    while (result.next()) {
        try {
            ...
            out.println("<td>");
            out.println("<button class='icon-btn' onclick='showEditModal(" + sno + ", \"" + regdno + "\", \"" + studentname + "\", \"" + mobileno + "\")'><i class='fas fa-edit edit'></i></button>");
            out.println("<button class='icon-btn' onclick='deleteRow(" + sno + ")'><i class='fas fa-trash delete'></i></button>");
            out.println("</td>");
            out.println("</tr>");
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <form id="editForm" method="post" action="AdminStudTeacEditRecord.jsp">
            ...
            <input type="text" id="editSno" name="sno" readonly><br> <!-- Add readonly attribute -->
