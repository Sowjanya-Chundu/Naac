...
<body>
    <div class="container">
        ...
        <% 
            ...
            if (registrationNumber != null && !registrationNumber.isEmpty() && studentName != null && !studentName.isEmpty()) {
                ...
                try {
                    ...
                    String deleteQuery = "DELETE FROM studentsdata WHERE rollno = ? AND Name = ?";
                    ...
                    // Get updated count of students
                    String countQuery = "SELECT COUNT(*) AS total_students FROM studentsdata";
        ...
        %>
                    <div class="message">
                        <% if (rowsAffected > 0) { %>
                            Student with Registration Number <%= registrationNumber %> and Name <%= studentName %> deleted successfully.<br>
                            Total Students: <%= totalStudents %>
                        <% } else { %>
                            No student found with Registration Number <%= registrationNumber %> and Name <%= studentName %>.<br>
                            Total Students: <%= totalStudents %>
                        <% } %>
                    </div>
        <% 
                    ...
                    e.printStackTrace();
                    out.println("<div class='message'>Error deleting student record.</div>");
                } finally {
                    try {
